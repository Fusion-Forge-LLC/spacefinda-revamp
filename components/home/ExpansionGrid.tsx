    ...
    <section className="py-24 bg-[#FEFEFE]">
      <Wrapper>
        <div className="max-w-2xl mb-12">
          <div className="inline-block px-3 py-1 bg-yellow/10 rounded-full text-yellow text-[10px] font-bold tracking-widest uppercase mb-4">
              ...
              <div 
                ...
                className={
                  cn("relative rounded-2xl flex text-white capitalize justify-center items-center gap-2.5 overflow-hidden", 
                     index === 2 ? "row-span-1 md:row-span-2" : "row-span-1")}
              >
                <Image className="flex-1" src={city.image} alt={city.city} />
                <div
                  className="left-3 bottom-3 absolute"
                >
                  <span className="justify-start text-Text-Pure-White text-3xl font-semibold font-['Inter'] leading-10">
                    {city.city}
                  </span>                    
                  <span
                      className={cn("block rounded-full p-1.5 text-center text-sm font-medium font-['Geist'] leading-5",
